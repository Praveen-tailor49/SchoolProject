...
-- Run this SQL file in MySQL to create all required tables
...
('Super Admin', 'Full system access with all permissions', '["dashboard","students_view","students_edit","students_delete","teachers_view","teachers_edit","classes_manage","attendance_manage","fees_view","fees_manage","reports_view","settings_manage"]', 'purple'),
('Admin', 'Administrative access with limited settings', '["dashboard","students_view","students_edit","teachers_view","teachers_edit","classes_manage","attendance_manage","fees_view","reports_view"]', 'indigo'),
('Teacher', 'Access to teaching related features', '["dashboard","students_view","attendance_manage"]', 'blue'),
('Accountant', 'Access to financial features only', '["dashboard","fees_view","fees_manage","reports_view"]', 'green');
